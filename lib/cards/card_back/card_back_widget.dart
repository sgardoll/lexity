                            ...
                            Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  ...
                                  logFirebaseEvent('Column_stop_sound');
                                          ...
                                          Builder(
                                            builder: (context) =>
                                              ...
                                              onPressed: () async {
                                                ...
                                                await Share.share(
                                                  valueOrDefault<String>(
                                                    'https://lexity.connectio.com.au/start?id=${widget!.doc?.reference.id}',
                                                    'https://lexity.connectio.com.au/start',
                                                  ),
                                                  sharePositionOrigin:
              ...
              Padding(
                ...
                child: Material(
                  ...
                  child: Container(
                    ...
                    child: Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(15.0, 0.0, 16.0, 12.0),
                      child: Row(
                        mainAxisSize: MainAxisSize.max,
                          ...
                          Expanded(
                            child: Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'CARD_BACK_COMP_Back_ON_TAP');
                                  logFirebaseEvent('Back_widget_animation');
                                  if (animationsMap[
                                          'containerOnActionTriggerAnimation'] !=
                                      null) {
                                    await animationsMap[
                                  ...
                                  logFirebaseEvent('Back_stop_sound');
                                  _model.soundPlayer1?.stop();
                                  logFirebaseEvent('Back_stop_sound');
                                  _model.soundPlayer2?.stop();
                                  logFirebaseEvent('Back_execute_callback');
                          ...
                          Expanded(
                            child: Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'CARD_BACK_COMP_Flip_ON_TAP');
                                  logFirebaseEvent('Flip_widget_animation');
                                  if (animationsMap[
                                          'containerOnActionTriggerAnimation'] !=
                                      null) {
                                    await animationsMap[
                                  ...
                                  logFirebaseEvent('Flip_stop_sound');
                                  _model.soundPlayer2?.stop();
                                  logFirebaseEvent('Flip_stop_sound');
                                  _model.soundPlayer1?.stop();
                                  logFirebaseEvent('Flip_execute_callback');
                                  await widget.turn?.call();
                                },
                                child: Column(
                                  mainAxisSize: MainAxisSize.min,
